app.controller("detail_ctrl", ['$scope', '$rootScope', '$http', function($scope, $rootScope, $http) {
    ...
    $scope.init_course_detail = function() {
        $http.get(serverUrl+"/course/detail",{params:{userToken: window.localStorage['userToken']}})
            .success(function(ret) {
                var ele = angular.element(document.querySelector("#coursesList>ul"));
                ele.empty();
